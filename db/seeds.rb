...
# Разделы
sections = [
  { name: 'Биомеханика',         slug: 'biomechanics',
    description: 'Биомеханика опорно-двигательного аппарата и физиологии движений' },
...
# Теги
tag_names = %w[АТФ мышцы метаболизм биомеханика суставы реабилитация аэробный анаэробный
               гормоны питание]
...
articles_data = [
  ...
  },
  {
    ...
    tags: [tags.find { |t| t.name == 'мышцы' }, tags.find { |t| t.name == 'аэробный' }, tags.find do |t|
      t.name == 'анаэробный'
    end]
  },
  {
  ...
  },
  {
    ...
    tags: [tags.find { |t| t.name == 'питание' }, tags.find { |t| t.name == 'метаболизм' }, tags.find do |t|
      t.name == 'аэробный'
    end]
  },
  {
...
Article.published.first(3).each do |article|
  ...
  Comment.create!(article: article, user: admin,
                  body: 'Спасибо! Материал подготовлен на основе актуальных исследований.')
end
